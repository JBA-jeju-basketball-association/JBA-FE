...
type Props = {
    usingGalleryArea: boolean;
    setUsingGalleryArea:  React.Dispatch<React.SetStateAction<boolean>>;
}
export const GalleryArea = ({usingGalleryArea, setUsingGalleryArea}:Props) => {
                            ...
                            <div className={style.rightAreaColumn}>
                                {data?.galleries?.length > 1 &&
                                    <div className={style.rightImgBox}>
                                        <GalleryCardContent title={data.galleries[1].title}
                                                            date={data.galleries[1].createAt}/>
                                        <img src={data.galleries[1].imgUrl} alt={"main-gallery2"}
                                             onClick={() => navigateDetail(data.galleries[1].galleryId)}/>
                                    </div>
                                }
                                {data?.galleries?.length > 2 &&
                                    <div className={style.rightImgBox}>
                                        <GalleryCardContent title={data.galleries[2].title}
                                                            date={data.galleries[2].createAt}/>
                                        <img src={data.galleries[2].imgUrl} alt={"main-gallery3"}
                                             onClick={() => navigateDetail(data.galleries[2].galleryId)}/>
                                    </div>
                                }
                            </div>
                            <div className={style.rightAreaColumn}>
                                {data?.galleries?.length > 3 &&
                                    <div className={style.rightImgBox}>
                                        <GalleryCardContent title={data.galleries[3].title}
                                                            date={data.galleries[3].createAt}/>
                                        <img src={data.galleries[3].imgUrl} alt={"main-gallery4"}
                                             onClick={() => navigateDetail(data.galleries[3].galleryId)}/>
                                    </div>
                                }
                                {data?.galleries?.length > 4 &&
                                    <div className={style.rightImgBox}>
                                        <GalleryCardContent title={data.galleries[4].title}
                                                            date={data.galleries[4].createAt}/>
                                        <img src={data.galleries[4].imgUrl} alt={"main-gallery5"}
                                             onClick={() => navigateDetail(data.galleries[4].galleryId)}/>
                                    </div>
                                }
                            </div>
                        </div>
