  ...
  return (
    <div className={style.SearchBox}>
      <div>
        ...
        >
          {searchCategory} {dropdownVisibility ? "▲" : "▼"}
        </button>
        {dropdownVisibility && (
          <ul className={style.liBox}>
            <li onClick={(e) => handleSearchCategory("전체")}>
              {searchCategory === "전체" ? "▻" : ""} 전체
            </li>
            <li onClick={(e) => handleSearchCategory("제목")}>
              {searchCategory === "제목" ? "▻" : ""} 제목
            </li>
            <li onClick={(e) => handleSearchCategory("내용")}>
              {searchCategory === "내용" ? "▻" : ""} 내용
            </li>
          </ul>
        )}
      </div>
